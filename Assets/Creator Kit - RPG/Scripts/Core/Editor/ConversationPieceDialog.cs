...
namespace RPGM.Gameplay
{
    ...
    public class ConversationPieceDialog : ScriptableWizard
    {
        ...
        void OnDrawOption(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            //something would go here i guess
            r.x += r.width;
        ...
        protected override bool DrawWizardGUI()
        {
            ...
            /*
             * I would put the dropdown here but I don't really understand it
             
            EditorGUILayout.PrefixLabel("Image Alignment(Optional)");
            conversationPiece.image.position = (Sprite)EditorGUILayout.ObjectField(conversationPiece.image.position, typeof(Sprite), false);
          *    */
